...
public class StocksHttp {
    ...
    public static String URL="https://api.hgbrasil.com/finance/quotations?format=json&key=671ec8fe";
    ...
    public static Stocks getStocksFromJson(JSONObject json){
        ...
        try {
            ...
            svariation=json.getDouble("variation");
            ...
            marca= new Stocks(sname, location,points, svariation);
        }catch (JSONException e){
